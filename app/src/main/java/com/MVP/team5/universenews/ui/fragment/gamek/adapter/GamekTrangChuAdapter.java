...
/**
 * Created by Fpoly on 11/24/2017.
 */

public class GamekTrangChuAdapter extends BaseAdapter {
    private ArrayList<Gamek_TrangChu_Content> list;
    private Context context;

    public GamekTrangChuAdapter(ArrayList<Gamek_TrangChu_Content> list, Context context) {
        this.list = list;
    ...
    @Override
    public Gamek_TrangChu_Content getItem(int i) {
        return list.get(i);
    }
