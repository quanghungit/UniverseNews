...
public class DanTriVHAdapter extends BaseAdapter {
    private ArrayList<DanTri_VH_Content> list;
    private Context context;

    public DanTriVHAdapter(ArrayList<DanTri_VH_Content> list, Context context) {
        this.list = list;
    ...
    @Override
    public DanTri_VH_Content getItem(int i) {
        return list.get(i);
    }
