...
public class GenkMobileAdapter extends BaseAdapter{
    private ArrayList<Genk_Mobile_Content> list;
    private Context context;

    public GenkMobileAdapter(ArrayList<Genk_Mobile_Content> list, Context context) {
        this.list = list;
    ...
    @Override
    public Genk_Mobile_Content getItem(int i) {
        return list.get(i);
    }
