 ...
 */
public class PcConsoleGamekFragment extends Fragment {
    private static final String TAG = "PcConsoleGamekFragment";
    private ListView listView;
    private ArrayList<Gamek_PC_Content> datas;
    private GamekPcAdapter adapter;
    private SwipeRefreshLayout swipeRefreshLayout;

    public PcConsoleGamekFragment() {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        return inflater.inflate(R.layout.fragment_pcconsolegamek, container, false);
    }
        ...
        new AsyncTask<Void, Void, ArrayList<Gamek_PC_Content>>() {
            ...
            protected ArrayList<Gamek_PC_Content> doInBackground(Void... voids) {
                try {
                    ...
                    String des = "";
                    String img = "";
                    Document document = Jsoup.connect("http://gamek.vn/pc-console.chn").get();
