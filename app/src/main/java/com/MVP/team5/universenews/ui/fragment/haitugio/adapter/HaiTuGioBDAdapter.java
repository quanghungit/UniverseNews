...
public class HaiTuGioBDAdapter extends BaseAdapter {
    private ArrayList<HaiTuGio_BD_Content> list;
    private Context context;

    public HaiTuGioBDAdapter(ArrayList<HaiTuGio_BD_Content> list, Context context) {
        this.list = list;
    ...
    @Override
    public HaiTuGio_BD_Content getItem(int i) {
        return list.get(i);
    }
