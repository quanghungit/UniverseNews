...
public class HaiTuGioTCAdapter extends BaseAdapter {
    private ArrayList<HaiTuGio_TC_Content> list;
    private Context context;

    public HaiTuGioTCAdapter(ArrayList<HaiTuGio_TC_Content> list, Context context) {
        this.list = list;
    ...
    @Override
    public HaiTuGio_TC_Content getItem(int i) {
        return list.get(i);
    }
