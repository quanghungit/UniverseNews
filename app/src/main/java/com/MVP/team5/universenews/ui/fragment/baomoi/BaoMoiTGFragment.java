...
import com.MVP.team5.universenews.ui.fragment.baomoi.adapter.BaoMoiTGAdapter;
 ...
 */
public class BaoMoiTGFragment extends Fragment {

    private static final String TAG = "HaiTuGioTCFragment";
    private SwipeRefreshLayout swipeRefreshLayout;

    ListView list;
    ArrayList<BaoMoi_TG_Content> datas;
    BaoMoiTGAdapter adapter;


    public BaoMoiTGFragment() {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        return inflater.inflate(R.layout.fragment_baomoi_thegioi, container, false);
    }

    @Override
    public void onViewCreated(View view, @Nullable Bundle savedInstanceState) {
        super.onViewCreated(view, savedInstanceState);
        list = view.findViewById(R.id.baomoi_tg_listview);
        swipeRefreshLayout = view.findViewById(R.id.baomoi_tg_refresh);
        setupData();
    ...
    private void setUpWidget(ArrayList<BaoMoi_TG_Content> datas) {
        BaoMoiTGAdapter adapter = new BaoMoiTGAdapter(datas, getActivity());
    ...
    private void setupData() {
        new AsyncTask<Void, Void, ArrayList<BaoMoi_TG_Content>>() {
            ArrayList<BaoMoi_TG_Content> datas = new ArrayList<>();

            @Override
            protected ArrayList<BaoMoi_TG_Content> doInBackground(Void... voids) {
                try {
                    String title = "";
                    String link = "";
                    String des = "";
                    ...
                    for (Element element : elements) {
                        ...
                        datas.add(new BaoMoi_TG_Content(title, linkd, des, img));
                    }
                } catch (Exception e) {
            ...
            @Override
            protected void onPostExecute(ArrayList<BaoMoi_TG_Content> data) {
