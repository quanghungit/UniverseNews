...
public class HaiTuGioCNTTAdapter extends BaseAdapter {
    private ArrayList<HaiTuGio_CNTT_Content> list;
    private Context context;

    public HaiTuGioCNTTAdapter(ArrayList<HaiTuGio_CNTT_Content> list, Context context) {
        this.list = list;
    ...
    @Override
    public HaiTuGio_CNTT_Content getItem(int i) {
        return list.get(i);
    }
