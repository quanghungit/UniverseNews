...
public class BaoMoiGTAdapter extends BaseAdapter {
    private ArrayList<BaoMoi_GT_Content> list;
    private Context context;

    public BaoMoiGTAdapter(ArrayList<BaoMoi_GT_Content> list, Context context) {
        this.list = list;
    ...
    @Override
    public BaoMoi_GT_Content getItem(int i) {
        return list.get(i);
    }
