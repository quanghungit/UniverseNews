...
import com.MVP.team5.universenews.ui.fragment.genk.model.Genk_TrangChu_Content;
...
public class GenkTrangChuAdapter extends BaseAdapter{
    private ArrayList<Genk_TrangChu_Content> list;
    private Context context;

    public GenkTrangChuAdapter(ArrayList<Genk_TrangChu_Content> list, Context context) {
        this.list = list;
    ...
    @Override
    public Genk_TrangChu_Content getItem(int i) {
        return list.get(i);
    }
...
//            holder.link = view.findViewById(R.id.gamek_trangchu_customview_link);
        ...
        holder.cardView.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                ((MainActivity)context).changeFragment(GamekWebviewFragment.newInstance(bundle, 2));
