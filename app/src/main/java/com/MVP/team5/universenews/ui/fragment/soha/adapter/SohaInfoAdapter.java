...
import com.MVP.team5.universenews.ui.fragment.soha.model.Soha_Info_Content;
...
public class SohaInfoAdapter extends BaseAdapter {
    private ArrayList<Soha_Info_Content> list;
    private Context context;

    public SohaInfoAdapter(ArrayList<Soha_Info_Content> list, Context context) {
        this.list = list;
    ...
    @Override
    public Soha_Info_Content getItem(int i) {
        return list.get(i);
    }
