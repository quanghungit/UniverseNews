...
public class SohaTSAdapter extends BaseAdapter {
    private ArrayList<Soha_TS_Content> list;
    private Context context;

    public SohaTSAdapter(ArrayList<Soha_TS_Content> list, Context context) {
        this.list = list;
    ...
    @Override
    public Soha_TS_Content getItem(int i) {
        return list.get(i);
    }
