...
public class BaoMoiTTAdapter extends BaseAdapter {
    private ArrayList<BaoMoi_TT_Content> list;
    private Context context;

    public BaoMoiTTAdapter(ArrayList<BaoMoi_TT_Content> list, Context context) {
        this.list = list;
    ...
    @Override
    public BaoMoi_TT_Content getItem(int i) {
        return list.get(i);
    }
