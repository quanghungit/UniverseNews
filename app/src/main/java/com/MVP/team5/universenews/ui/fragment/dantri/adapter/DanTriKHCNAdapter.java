...
public class DanTriKHCNAdapter extends BaseAdapter {
    private ArrayList<DanTri_KHCN_Content> list;
    private Context context;

    public DanTriKHCNAdapter(ArrayList<DanTri_KHCN_Content> list, Context context) {
        this.list = list;
    ...
    @Override
    public DanTri_KHCN_Content getItem(int i) {
        return list.get(i);
    }
...
//            holder.link = view.findViewById(R.id.gamek_trangchu_customview_link);
        ...
        holder.itemView.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                ((MainActivity)context).changeFragment(GamekWebviewFragment.newInstance(bundle, 3));
