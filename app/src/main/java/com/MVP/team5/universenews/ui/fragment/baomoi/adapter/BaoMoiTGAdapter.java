...
public class BaoMoiTGAdapter extends BaseAdapter {
    private ArrayList<BaoMoi_TG_Content> list;
    private Context context;

    public BaoMoiTGAdapter(ArrayList<BaoMoi_TG_Content> list, Context context) {
        this.list = list;
    ...
    @Override
    public BaoMoi_TG_Content getItem(int i) {
        return list.get(i);
    }
