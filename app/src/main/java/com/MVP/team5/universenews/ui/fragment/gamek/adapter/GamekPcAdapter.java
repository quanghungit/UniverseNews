...
public class GamekPcAdapter extends BaseAdapter{
    private ArrayList<Gamek_PC_Content> list;
    private Context context;

    public GamekPcAdapter(ArrayList<Gamek_PC_Content> list, Context context) {
        this.list = list;
    ...
    @Override
    public Gamek_PC_Content getItem(int i) {
        return list.get(i);
    }
